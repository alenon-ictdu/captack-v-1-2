...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="shortcut icon" href="{{ asset('logo-black.png') }}">
...
<body>
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{ route('dashboard') }}">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('logo-min-white.png') }}" alt="homepage" class="light-logo" style="width: 40px;" />
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="{{ asset('logo-full-white.png') }}" alt="homepage" class="light-logo" style="width: 150px;" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" id="2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" @if($penalty_num > 0) style="color:#da542e;" @endif> <i class="font-24 mdi mdi-bell"></i>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown scrollable" aria-labelledby="2">
                                <ul class="list-style-none">
                                    <li>
                                        <div class="">
                                            <div class="border-bottom">
                                                <p style="text-align: center;padding-top: 13px;">Not Returned Books</p>
                                            </div>
                                             <!-- Penalty -->
                                            @foreach($public_borrowers as $row)
                                                <a href="javascript:void(0)" class="link border-top">
                                                    <div class="d-flex no-block align-items-center p-10">
                                                        <span class="btn btn-success btn-circle"><i class="fas fa-book"></i></span>
                                                        <div class="m-l-10">
                                                            <h5 class="m-b-0">{{ $row->firstname. ' ' .$row->lastname }}</h5> 
                                                            <span class="mail-desc">{{ $row->book->title }}</span> 
                                                            <span class="text-muted float-right">{{date('F d, Y',strtotime($row->deadline) )}}</span>
                                                        </div>
                                                    </div>
                                                </a>
                                            @endforeach
                                            <div class="border-top ">
                                                <a href="{{ route('book.penalty') }}" style="text-align: center;">See all</a>
                                            </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="{{ route('view.user') }}"><i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                © 2018 Capstack All Rights Reserved{{-- <a href="https://wrappixel.com">Link</a> --}}
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
    ...
    {{-- <script src="{{asset('dist/fastselect.js')}}"></script> --}}
